...
//  }
 ...
 if (answers) {
   ...
   Quiz.innerHTML = `<h2> You answered   ${ score} correctly out of ${QuizData.length } questions </h2> <button><a href="./index.html"></a>Quit</button> <button onclick ="location.reload()">play again</button>`;
   }
 }
});
